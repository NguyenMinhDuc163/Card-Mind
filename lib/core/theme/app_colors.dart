...
class AppColors {
  static const Color electricBlue = Color(0xFF0B1D3B);

  static const Color deepBlue = Color(0xFF0E2B5C);
  ...
  static const Color tealGreen = Color(0xFF00FFEA);
  static const Color vibrantBlue = Color(0xFF4A60FF);
